...
def main(): 
    ...
    while True: 
        ...
        playground.draw()
        # print(f'potential:\t{playground.physics.potential():.0f}\nkinetic:\t{playground.physics.kinetic():.0f}\ntotal:  \t{playground.physics.kinetic()+playground.physics.potential():.0f}')
        pygame.display.flip()
